...
public class ErrorCodeNum {
    ...
    public final static String CODE_LIST = "E005";
    public final static String CODE_BUYING_CHECK = "E006";
    public final static String CODE_CHECK_UID = "E007";
    public final static String CODE_SIGNIN_UPW = "E008";
